...
public class ttshangDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ttshangDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ttshangResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ttshang");

            options.DefaultResourceType = typeof(ttshangResource);
        ...
        {
            options.MapCodeNamespace("ttshang", typeof(ttshangResource));
        });
    }
}
